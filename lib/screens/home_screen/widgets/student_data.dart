    ...
    return Container(
      ...
      child: Center(
        child: Text(
          ...
          style: Theme.of(
            context,
          ).textTheme.titleSmall!.copyWith(color: kTextBlackColor),
        ),
      ),
    );
  }
        ...
        child: Column(
          ...
          children: [
            Text(
              ...
              style: Theme.of(
                context,
              ).textTheme.titleMedium!.copyWith(color: kTextBlackColor),
            ),
            Text(
              value,
              style: Theme.of(
                context,
              ).textTheme.titleSmall!.copyWith(color: kTextLightColor),
            ),
          ],
        ),
      ),
